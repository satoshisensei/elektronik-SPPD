                        ...
                        <div class="p-5">
                            ...
                            @csrf
                                <div class="form-group">
                                    ...
                                    is-invalid
                                    @enderror" id="name" name="name" required autocomplete="name"
                                ...
                                @enderror
                                <div class="form-group">
                                    <input type="email" id="email" name="email" class="form-control form-control-user @error('email')
                                            is-invalid
                                            @enderror" required autocomplete="email"
