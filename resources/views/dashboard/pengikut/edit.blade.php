    ...
    <div class="container container-fluid d-flex justify-content-center">
        <div class="col-md-8 ">
            <div class="portlet light bordered">
                    <div class="form-body">
                        <form action="/pengikut/{{ $pengikuts[0]->id }}" method="post">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama')
                                is-invalid
                            @enderror" id="nama" name="nama" placeholder="Masukan Nama..." autofocus required value="{{ old('nama', $pengikuts[0]->nama) }}">
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('umur')
                                is-invalid
                            @enderror" id="umur" name="umur" placeholder="Masukan Umur..." autofocus required value="{{ old('umur',$pengikuts[0]->umur) }}">
                            @error('umur')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
